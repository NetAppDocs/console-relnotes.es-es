...
Para obtener más información, consulte link:https://docs.netapp.com/us-en/data-services-disaster-recovery/use/drplan-create.adoc["Crear un plan de replicación"].
...
Para obtener más información, consulte link:https://docs.netapp.com/us-en/data-services-disaster-recovery/reference/switch-console-agents.html["Agentes de la consola Switch"].
