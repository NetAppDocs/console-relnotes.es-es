...
Ransomware Resilience ahora le permite editar el estado de las alertas de comportamiento del usuario. Puede descartar y resolver alertas manualmente. Ahora también puedes marcar las alertas como "En revisión".

Para obtener más información, consulte xref:rp-use-alert.html[Administrar alertas].
